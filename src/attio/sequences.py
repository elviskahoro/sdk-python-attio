...
class Sequences(BaseSDK):
    ...
    def post_v2_sequences_unsubscribed_emails(
        self,
        *,
        data: Union[
            models.PostV2SequencesUnsubscribedEmailsDataRequest,
            models.PostV2SequencesUnsubscribedEmailsDataRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.PostV2SequencesUnsubscribedEmailsResponse:
        r"""Add emails to the unsubscribe list
        ...
        request = models.PostV2SequencesUnsubscribedEmailsRequest(
            data=utils.get_pydantic_model(
                data, models.PostV2SequencesUnsubscribedEmailsDataRequest
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                False,
                "json",
                models.PostV2SequencesUnsubscribedEmailsRequest,
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="post_/v2/sequences/unsubscribed_emails",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.PostV2SequencesUnsubscribedEmailsResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.PostV2SequencesUnsubscribedEmailsValidationTypeErrorData,
                http_res,
            )
            raise errors.PostV2SequencesUnsubscribedEmailsValidationTypeError(
    ...
    async def post_v2_sequences_unsubscribed_emails_async(
        self,
        *,
        data: Union[
            models.PostV2SequencesUnsubscribedEmailsDataRequest,
